...
function Footer() {
  return (
    <div>
      <div className="footer-container mt-10 md:mt-16 lg:mt-28 py-16 md:py-24 grid md:grid-cols-2 gap-6 md:gap-14 justify-center md:justify-between items-center px-4 lg:px-10 xl:px-60 2xl:px-72">
        <div className="left">
          <div className="logo">
            <img
              className="w-16"
      ...
      <div className="copy-right">
        <p className="text-xl font-rancho text-white text-center py-4">
          Copyright Espresso Emporium ! All Rights Reserved by @Mahadi Hasan
        </p>
      </div>
    </div>
  );
